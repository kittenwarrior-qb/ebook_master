...
export class BooksController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get all books', description: 'Retrieve all books, optionally filtered by category' })
  @ApiQuery({ name: 'category', required: false, enum: ['book', 'test'], description: 'Filter by category' })
